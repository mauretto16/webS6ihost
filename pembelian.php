...
<form method="post">
	...
	?>
            ...
            <td class="text-center" style="vertical-align:middle;">
                  <a href="pembelian-cetak.php?id_pembelian=<?=$row['id_pembelian'] ?>" class="btn btn-warning" target="_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
